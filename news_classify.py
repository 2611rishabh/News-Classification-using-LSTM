...
with open("C:\\Users\\HP\\Desktop\\programs\\news classify\\BBC News Train.csv", 'r') as csvfile:
    print(f"CSV header:\n {csvfile.readline()}")
    print(f"First data point:\n {csvfile.readline()}")

# Checking testing data
with open("C:\\Users\\HP\\Desktop\\programs\\news classify\\BBC News Test.csv", 'r') as csvfile:
    print(f"CSV header:\n {csvfile.readline()}")
    print(f"First data point:\n {csvfile.readline()}")
...
sentences, labels = parse_data_from_file("C:\\Users\\HP\\Desktop\\programs\\news classify\\BBC News Train.csv")
...
test_sentences = parse_test_data_from_file("C:\\Users\\HP\\Desktop\\programs\\news classify\\BBC News Test.csv")
